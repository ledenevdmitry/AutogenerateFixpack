...
namespace AutogenerateFixpack.OraUtils
{
    class DBManager : IDisposable
    {
        ...
        static DBManager()
        {
            CreateConn(Properties.Settings.Default.STABConnString);
        }
        ...
        private static void CreateConn(string TNS)
        {
            ...
            {
                throw new ArgumentException("Задайте правильный TNS Connection String", exc);
            }
